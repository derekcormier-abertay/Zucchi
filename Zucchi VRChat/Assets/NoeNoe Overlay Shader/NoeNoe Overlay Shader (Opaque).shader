...
////// Emissive:
                ...
                float2 node_4737 = float2(saturate(dot((normalDirection*faceSign),lerp((node_7394_if_leA*_StaticToonLight.rgb)+(node_7394_if_leB*_StaticToonLight.rgb),(float3(node_8628.r,_StaticToonLight.g,node_8628.g)+float3(node_3851.r,_StaticToonLight.g,node_3851.g)),node_7394_if_leA*node_7394_if_leB))),0.2);
                float4 node_6405 = tex2D(_Ramp,TRANSFORM_TEX(node_4737, _Ramp));
                float node_9074 = 3.0;
                float2 node_2538 = float2(saturate(dot(normalDirection,(faceSign*lightDirection))),0.2);
